...
import { polygonInPolygon, Point } from "../src/";

tape("polygonInPolygon(polygonA, polygonB) determines whether a polygon is contained by another polygon", (test: any) => {
...
tape("polygonInPolygon(polygonA, polygonB) returns false if all of polygonA's vertices fall inside polygonB but one of its lines intersects polygonB", (test: any) => {
...
tape("If polygonA in polygonInPolygon is forced closed, polygonA will not be altered", (test: any) => {
