...
import { lineIntersectsPolygon, Line, Point } from "../src/";

tape("lineIntersectsPolygon(line, polygon) determines whether a line intersects a polygon", (test: any) => {
...
tape("lineIntersectsPolygon(line, polygon) should return true even if the line is only collinear with one of the polygon's segments", (test: any) => {
