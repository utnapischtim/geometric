...
import { polygonScaleY, Point } from "../src/";

tape("polygonScaleY(polygon, scaleFactor, origin) scales a polygon's y-coordinates by a scale factor from an origin point.", (test: any) => {
